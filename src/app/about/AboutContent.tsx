    ...
    <div className="min-h-screen bg-[#0a0a0a] pt-32 pb-24 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-10 text-[#e8e6e1]/70 text-base font-light leading-[2] mb-24">
          ...
          <FadeBlock>
            <p>mumuは、そういう瞬間のために生まれました。</p>
          </FadeBlock>
          <FadeBlock>
            <p>
              珈琲を淹れる、その一滴一滴の時間。豆を挽く音、湯気の香り、カップを包む温もり。それはほんの数分間のことかもしれないけれど、その小さな丁寧さが、少しだけ自分に戻るきっかけになる。
            </p>
          </FadeBlock>
          <FadeBlock>
            <p>
          ...
          <FadeBlock>
            <p>
              灯台は、暗い海の中で方向を示す存在です。mumuの珈琲が、忙しい日常の中で感性を取り戻すための、小さな灯台になれたら——そんな思いで、今日も豆を焙煎しています。
            </p>
          </FadeBlock>
          <FadeBlock>
