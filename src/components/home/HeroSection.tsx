...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        <h1 className="text-[#e8e6e1] text-3xl md:text-5xl font-light leading-relaxed tracking-widest mb-6">
          感性が、ふと、
          <br />
          戻ってくる場所。
        </h1>
        <p className="text-[#e8e6e1]/50 text-sm md:text-base font-light tracking-[0.3em]">
          灯台の珈琲焙煎所 mumu
        </p>
      </motion.div>
      ...
      >
        <span className="text-[#e8e6e1]/30 text-xs font-light tracking-[0.3em]">scroll</span>
        {/* 縦線が下に流れるアニメーション */}
        <div className="relative w-px h-10 bg-[#e8e6e1]/10 overflow-hidden">
          <motion.div
