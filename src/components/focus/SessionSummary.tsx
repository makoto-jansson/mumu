...
export default function SessionSummary({ sets, totalMinutes, task }: Props) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[30] bg-[#0e0e0e] flex flex-col px-6 pt-16 pb-24 overflow-y-auto"
    >
      <div className="max-w-sm mx-auto w-full flex flex-col gap-8">
        ...
        >
          {/* 珈琲豆アイコン */}
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none" className="shrink-0 mt-0.5 text-[#a3a957]/60 group-hover:text-[#a3a957] transition-colors duration-300" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
