...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#0e0e0e]/95 backdrop-blur-sm border-t border-white/10">
            ...
            >
              ...
              <span
                className={`text-[10px] font-light tracking-wider transition-colors duration-300 ${
                  isActive ? "text-[#a3a957]" : "text-[#e8e6e1]/40"
                }`}
              >
                {item.label}
              </span>
